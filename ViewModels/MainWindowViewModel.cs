...
public partial class MainWindowViewModel : ViewModelBase
{
    ...
    [ObservableProperty]
    private string _statusMessage = "App is running";
    ...
    public MainWindowViewModel()
    {
        ...
        _panther.VoiceGiven += (s, e) => AddLogMessage("Panther: *growls*");
        _dog.VoiceGiven += (s, e) => AddLogMessage("Dog: *barks*");
    }
    ...
    private void PantherMove()
    {
        ...
        {
            AddLogMessage("The panther is in a tree and can't move");
            return;
        }
    ...
    private void PantherStand()
    {
        if (_panther.IsOnTree)
        {
            AddLogMessage("Panther is in a tree and can't stand up");
            return;
        }
    ...
    {
        _panther.ClimbTree();
        AddLogMessage("Panther climbed a tree");
    }
    ...
    private void PantherGetDown()
    {
        ...
        AddLogMessage("The panther came down from the tree");
    }
